...
<div style="text-align:center">
  ...
  <div class="row justify-content-between">
     <div class="img_container col-lg-4 col-offset-12 special-grid best-seller">
      <a class="anchor_link" class="anchor_link" href="">
  ...
  <div class="img_container row justify-content-between">
     ...
     <div class="img_container col-lg-4 col-offset-12 special-grid best-seller">
      <a class="anchor_link" href="">
        ...
        <div class="img_container col-lg-4 col-offset-12 special-grid best-seller">
          <a class="anchor_link" href="">
                 <button class="button"><img src="https://www.kramer.co.uk/$WS/kraemer-pferdesport/websale8_shop-kraemer-pferdesport/benutzer/navigation/grafiken/hw20_sale_themen.jpg" class="imagy"></button>
          </a>
    </div>
     </div>
     </div>
