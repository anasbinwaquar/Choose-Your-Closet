        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="table.html"><i class="fas fa-table"></i><span>Seller Verifcation</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="table.html"><i class="fas fa-table"></i><span>Product Verifcation</span></a></li>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                         ...
                         @if($product -> isEmpty())
                         <p style="text-align: center;">NO Product ONE TO VERIFY</p>           
                         @else
