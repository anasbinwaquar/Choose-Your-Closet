...
<form name="ProductForm" id="ProductForm" action="{{ route('CreateProduct')}}" method="post" enctype="multipart/form-data" class="justify-content-center">
    ...
    <div  class="form-group checkbox-group" id="checkbox-group">
    	<label  >Sizes:</label>
    ...
    <div class="form-group" >
        ...
        <input type="file" class="" id="product_image" name="product_image" multiple required><br><br>
        <input class="btn btn-primary mb-2" type="submit" required>
    </div>
</form>
</div>
